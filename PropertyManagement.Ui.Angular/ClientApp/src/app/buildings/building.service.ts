...
export class BuildingService {
  ...
  getBuildings(): Observable<Building[]> {
    ...
    //this.httpClient.get(this.apiUrl + 'Building').subscribe((result) => {
    //  console.log(result);
    //}, error => console.error(error));

    //this.httpClient.get<Building[]>(this.apiUrl + 'Building').subscribe(result => {
    //  this.buildings = result;
    //}, error => console.error(error));


    //var s = this.httpClient.get<Building[]>(this.apiUrl + 'Building');
    //var z = this.extractBuildings(s.toString());
    //alert(s);
    var tt = this.httpClient.get<Building[]>(this.apiUrl + 'Building')
      .pipe(
      map(
